...
namespace MonteTestHarness
{
    internal class TestHarness
    {
        ...
        public static void runOrderAndChaosDevTest()
        {
            ...
            RandomAgent aiRandom = new RandomAgent();
            MCTSSimpleAgent aiMctsSimpleAgent = new MCTSSimpleAgent (1, 1.4, 36, 0.5);
            ModelBasedAgent modelBased = new ModelBasedAgent(model);
            MCTSWithPruning aiPruning = new MCTSWithPruning(2, 1.4, 36, model, 0.12, 0.5);
            MCTSWithLearning aiLearnt = new MCTSWithLearning(0.25, 1.4, 36, model, 0.5);
